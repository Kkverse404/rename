...
def _build_prompt(transcript: str, modules: tuple[str, ...]) -> str:
    ...
    return (
        ...
        "Write a verb-object task phrase that keeps only the current action and its key object: "
        "aim for 6-16 Chinese characters or 3-8 words in other languages. Never copy a "
        "conversational request as the summary. Remove pronouns, politeness, filler, and wrappers "
        "such as please, can you, our, my, \u6211\u4eec, \u5e2e\u6211, and \u4e00\u4e0b. "
        "For example, \u90fd\u7528\u6211\u4eec\u7684\u6bd4\u7279\u6d4f\u89c8\u5668"
        "\u6d4b\u8bd5\u4e00\u4e0b becomes "
